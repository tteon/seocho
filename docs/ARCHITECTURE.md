...
`docs/internal/RUNTIME_PACKAGE_MIGRATION.md`. Contributor-facing placement
guidance lives in `docs/MODULE_OWNERSHIP_MAP.md`, and each ownership domain's
quality grade + open gaps are tracked in `docs/internal/ARCHITECTURE_HEALTH.md`.
