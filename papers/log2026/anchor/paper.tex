...
6.3$\times$ a matched null under the schema-free condition but only
1.3$\times$ under FIBO --- even when two views provably hold the same
source fact, they embed it in almost disjoint structure (median Jaccard
0), and the ontology fragments that structure further. A structural
