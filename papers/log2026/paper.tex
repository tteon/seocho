...
policy surface, and amplifies whatever is wrong in any of them; in our
controlled tests, unrestricted broadcast leaked a protected field in 26 of 31
cases. Ask one fixed graph, and the required fact is simply absent. Neither is
