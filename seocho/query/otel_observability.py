...
class OTelBridge:
    ...
    def __init__(self, *, tracer: Any = None, meter: Any = None) -> None:
        ...
        if meter is not None:
            self._counters["agent_calls"] = meter.create_counter("seocho_agent_calls_total")
            ...
            self._histograms["latency"] = meter.create_histogram("seocho_agent_latency_ms")
    ...
    def record_usage(self, *, model: str, total_tokens: int, cost_usd: float | None, latency_ms: float) -> None:
