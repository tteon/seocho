...
_EXPORTS = {
    ...
    "EdgeCandidate": "learning",
    "LearningTaskScore": "learning",
    "OntologyLearningReport": "learning",
    "TermCandidate": "learning",
    "learn_from_graph": "learning",
    "score_learning_task": "learning",
    ...
    "repair_read": "freshness",
    "plan_read_repair": "freshness",
    "ReadRepairPlan": "freshness",
    "ReadRepairReport": "freshness",
    "ChangeAtom": "compatibility",
    "CompatibilityReport": "compatibility",
    "classify_ontology_change": "compatibility",
    "semver_distance": "compatibility",
    "check_publish_compatibility": "publish_gate",
    "PublishCompatibilityError": "publish_gate",
    "derive_drift_policy": "publish_gate",
    "build_upper_ontology": "upper",
    "render_upper_frame": "upper",
    "UPPER_CATEGORIES": "upper",
    ...
    "ProjectionMode": "plane_policy",
    "ProjectionDecision": "plane_policy",
    "ProjectionPolicyError": "plane_policy",
    "decide_projection": "plane_policy",
    "projection_trace_receipt": "plane_policy",
    "GovernedCandidateStager": "candidate_stage",
    "StagedCandidate": "candidate_stage",
    "graph_payload_to_turtle": "candidate_stage",
    "ModuleScorecard": "module_scorecard",
    "ModuleQualityPolicy": "module_scorecard",
    "ModuleQualityDecision": "module_scorecard",
    "score_module": "module_scorecard",
    "decide_module_quality": "module_scorecard",
    "quality_gate_payload": "module_scorecard",
    "VersionPinRegistry": "version_pin",
    "SafeReclamationGate": "reclamation",
    "ReclamationResult": "reclamation",
    "RetiredVersion": "reclamation",
    ...
    "run_rdf_governance": "rdf_governance",
    "verify_rdf_ontology_bundle": "rdf_governance",
    "write_rdf_governance_receipt": "rdf_governance",
