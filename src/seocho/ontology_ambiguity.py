"""Backward-compatible alias — canonical location is ``seocho.ontology.ambiguity``.

Kept because `seocho.ontology_ambiguity` is an import path users, docs and tests already use.
...
``seocho.ontology_ambiguity is seocho.ontology.ambiguity`` — one module object, not two.
...
from .ontology import ambiguity as _canonical
