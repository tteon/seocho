"""Backward-compatible alias — canonical location is ``seocho.ontology.artifacts``.

Kept because `seocho.ontology_artifacts` is an import path users, docs and tests already use.
...
``seocho.ontology_artifacts is seocho.ontology.artifacts`` — one module object, not two.
...
from .ontology import artifacts as _canonical
