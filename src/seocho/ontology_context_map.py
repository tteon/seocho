"""Backward-compatible alias — canonical location is ``seocho.ontology.context_map``.

Kept because `seocho.ontology_context_map` is an import path users, docs and tests already use.
...
``seocho.ontology_context_map is seocho.ontology.context_map`` — one module object, not two.
...
from .ontology import context_map as _canonical
