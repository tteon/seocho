"""Backward-compatible alias — canonical location is ``seocho.ontology.governance``.

Kept because `seocho.ontology_governance` is an import path users, docs and tests already use.
...
``seocho.ontology_governance is seocho.ontology.governance`` — one module object, not two.
...
from .ontology import governance as _canonical
