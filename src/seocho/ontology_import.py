"""Backward-compatible alias — canonical location is ``seocho.ontology.importers``.

Kept because `seocho.ontology_import` is an import path users, docs and tests already use.
...
``seocho.ontology_import is seocho.ontology.importers`` — one module object, not two.
...
from .ontology import importers as _canonical
