"""Backward-compatible alias — canonical location is ``seocho.ontology.ontoclean``.

Kept because `seocho.ontology_ontoclean` is an import path users, docs and tests already use.
...
``seocho.ontology_ontoclean is seocho.ontology.ontoclean`` — one module object, not two.
...
from .ontology import ontoclean as _canonical
