"""Backward-compatible alias — canonical location is ``seocho.ontology.scorecard``.

Kept because `seocho.ontology_scorecard` is an import path users, docs and tests already use.
...
``seocho.ontology_scorecard is seocho.ontology.scorecard`` — one module object, not two.
...
from .ontology import scorecard as _canonical
