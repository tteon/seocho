"""Backward-compatible alias — canonical location is ``seocho.ontology.versioning``.

Kept because `seocho.ontology_versioning` is an import path users, docs and tests already use.
...
``seocho.ontology_versioning is seocho.ontology.versioning`` — one module object, not two.
...
from .ontology import versioning as _canonical
