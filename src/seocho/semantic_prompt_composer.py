"""Canonical semantic prompt context composition.

This module owns the merge and render logic for ontology-, SHACL-, and
vocabulary-aware prompt context. Legacy extraction/runtime modules should call
into this module rather than maintaining separate merge logic.
"""
...
class DynamicPromptContext:
    ...
    shacl_constraints: str = ""
    vocabulary_terms: str = ""
    record_metadata_json: str = "{}"
    graph_context: str = ""
    entity_guidance: str = ""
    developer_instructions: str = ""
    ontology_context_notes: str = ""
    ...
    def to_dict(self) -> Dict[str, str]:
        return {
            ...
            "record_metadata_json": self.record_metadata_json,
            "graph_context": self.graph_context,
            "entity_guidance": self.entity_guidance,
            "developer_instructions": self.developer_instructions,
            "ontology_context_notes": self.ontology_context_notes,
        }


def compose_dynamic_prompt_context(
    *,
    category: str,
    source_type: str,
...
def build_dynamic_prompt_context(
    *,
    ...
    return compose_dynamic_prompt_context(
        category=category,
        source_type=source_type,
