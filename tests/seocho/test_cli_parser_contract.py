...
EXPECTED_ONTOLOGY_SUBCOMMANDS = {
    ...
    "datahub", "datahub-queue", "select-guardrail", "datahub-apply", "eval-answers", "learn", "import",
    "templates", "clone", "rdf-governance", "bundle", "activate", "status",
    "lease", "lock", "gc", "context",
}
